...
Market Signal Lab is an interactive technical-analysis dashboard for stocks, ETFs, indexes, and other instruments supported by Yahoo Finance. It converts adjusted daily market data into explainable indicators, a bullish/neutral/bearish signal, a technical-confidence score, and a historical strategy simulation.
...
- Explainable bullish, neutral, or bearish technical verdict
...
| **Signal** | Bullish, Neutral, or Bearish verdict | Summarizes the weighted technical rules |
...
- Score `>= +0.50`: **Bullish**
- Score `<= -0.50`: **Bearish**
- Score between those thresholds: **Neutral**
